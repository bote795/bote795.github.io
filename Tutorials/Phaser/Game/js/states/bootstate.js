...
MainGame.BootState.prototype = {
	...
	create: function(){
		...
		this.game.keys.SPECIAL  = game.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR);
		this.game.keys.Q        = game.input.keyboard.addKey(Phaser.Keyboard.Q);
		this.game.keys.SHIFT    = game.input.keyboard.addKey(Phaser.Keyboard.SHIFT);
